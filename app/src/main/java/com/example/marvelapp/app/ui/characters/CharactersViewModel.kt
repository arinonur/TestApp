package com.example.marvelapp.app.ui.characters
...
import com.example.marvelapp.app.ui.characters.source.CharactersSourceFactory
...
class CharactersViewModel(characterDataSource: CharacterDataSource) : BaseViewModel() {
    ...
    val characterComics = LivePagedListBuilder(charactersSourceFactory, config)
        .setFetchExecutor(Executors.newSingleThreadExecutor())
        .build()
